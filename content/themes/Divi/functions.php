...
if( function_exists('acf_add_options_page') ) {
	...
	acf_add_options_page('Editar Banners');
	acf_add_options_page('Editar Contatos');
	acf_add_options_page('Editar Clientes');
	acf_add_options_page('Editar Textos');
	acf_add_options_page('Editar Serviços');
